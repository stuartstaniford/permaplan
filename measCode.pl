...
open(FILE, "wc unixTime.cpp src/*.cpp include/*.h *.pl 812/*.oldf src/*.glsl CMakeLists.txt web/*.js web/views/*js README.md docs/*.md tests/test?.oldf tests/*.lctl tests/*.pl Materials/Trees/Regions/*.json co2-scenarios.json $otdlFiles|")
|| die("Couldn't run wc.\n");
