...
open(FILE, "wc unixTime.cpp src/*.cpp src/*.c include/*.h permaserv/*.cpp compilePermaserv openSrc *.pl 812/*.oldf src/*.glsl CMakeLists.txt web/*.js scripts/*.js css/*.css web/views/*js README.md docs/*.md $testFiles Materials/*.json $regionFiles co2-scenarios.json $otdlFiles|")
|| die("Couldn't run wc.\n");
