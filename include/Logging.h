...
// Log user management related errors
#ifdef LOG_USER_ERRORS
#define LogUserErrors(...)    \
                                  {\
                                    if(doLogUserErrors) \
                                      LogStatement("LogUserErrors: " __VA_ARGS__)\
                                    if(flushLogUserErrors)\
                                      LogFlush();\
                                  }
#else
#define LogUserErrors(...)
...
// Log details of user management
#ifdef LOG_USER_DETAILS
#define LogUserDetails(...)    \
                                  {\
                                    if(doLogUserDetails) \
                                      LogStatement("LogUserDetails: " __VA_ARGS__)\
                                    if(flushLogUserDetails)\
                                      LogFlush();\
                                  }
#else
#define LogUserDetails(...)
